...
export default function Student() {
  ...
  const handleSelectSchool = (schoolId) => dispatch(selectSchool({ schoolId }));
  const handleEnrollCourse = (courseId) => dispatch(enrollCourse({ courseId }));
  ...
  return (
    <div className="p-6 bg-amber-50 min-h-screen">
      ...
      {schools.map((school) => {
        ...
        return (
          <div key={school._id} className="bg-white rounded-2xl shadow-md p-5 mb-5 hover:shadow-xl transition">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {school.courses?.map((course) => {
                ...
                return (
                  <div key={course._id} className="flex justify-between items-center border p-3 rounded-lg hover:shadow-sm transition bg-amber-50">
